var EditableTable = function () {
    ...
    return {
        ...
        init: function () {
            ...
            jQuery('#editable-sample_wrapper .dataTables_filter input').attr("placeholder","请输入职位名称");
            ...
            $('#editable-sample a.delete').on('click', function (e) {
                ...
                if (confirm("您确定要删除这条信息吗？") == false) {
                    return;
                }
                var nRow = $(this).parents('tr')[0];
                oTable.fnDeleteRow(nRow);
                var title=$(this).attr("title");
                var url=$('#api_domain').val()+'JoinUs/delete_job';
                $.getJSON(url,{id:title});
                alert("删除成功！");
            });
